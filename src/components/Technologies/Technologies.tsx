        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {techData.map((cat, idx) => (
            <motion.div
              ...
              className="ios-glass p-6 md:p-8"
            >
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                {cat.items.map((item) => (
                  <motion.div
                    ...
                    className="flex flex-col items-center justify-center p-3 md:p-4 rounded-xl bg-white/5 transition-all duration-300 group cursor-default border border-transparent hover:border-white/10 min-h-[100px] md:min-h-[120px]"
                  >
                    <item.icon
                      className="w-7 md:w-8 h-7 md:h-8 mb-2 md:mb-3 text-gray-400 group-hover:text-white transition-colors"
                      style={{ color: item.color }}
                    />
                    <span className="text-xs md:text-sm font-medium text-gray-300 group-hover:text-white text-center">
                      {item.name}
                    </span>
                  </motion.div>
                ))}
