            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                <div className="w-16 h-16 rounded-full bg-primary-600/20 flex items-center justify-center mb-5 group-hover:bg-primary-600/30 transition-colors duration-300 relative">
                  <div className="absolute inset-0 rounded-full bg-primary-500/20 blur-md animate-pulse-slow opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <svg className="w-7 h-7 text-primary-400 relative z-10" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                  </svg>
                </div>
                <span className="text-gray-300 group-hover:text-primary-400 transition-colors duration-300 font-medium text-lg">Email</span>
              </a>
              ...
              >
                <div className="w-16 h-16 rounded-full bg-primary-600/20 flex items-center justify-center mb-5 group-hover:bg-primary-600/30 transition-colors duration-300 relative">
                  <div className="absolute inset-0 rounded-full bg-primary-500/20 blur-md animate-pulse-slow opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <svg className="w-7 h-7 text-primary-400 relative z-10" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-gray-300 group-hover:text-primary-400 transition-colors duration-300 font-medium text-lg">GitHub</span>
              </a>
              ...
              >
                ...
                <span className="text-gray-300 group-hover:text-primary-400 transition-colors duration-300 font-medium text-lg">LinkedIn</span>
              </a>
            </div>
          </div>
        </div>
