  ...
  return (
    <section className="section relative py-16 md:py-32" id="contact">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <span className="text-primary-400 font-semibold tracking-widest text-sm uppercase mb-2 block">Get in Touch</span>
          <h2 className="text-5xl font-bold mb-6">
            Let's Work <span className="liquid-text">Together</span>
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            Have an idea, product, or platform you want to build or improve? I'm open to collaborations, freelance opportunities, and technical projects where clean UX and solid engineering matter.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="ios-glass-strong p-8 md:p-10"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl font-semibold text-white transition-all duration-300 flex items-center justify-center gap-2 ${
                  isSubmitted ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'btn-liquid'
                }`}
              >
                {isSubmitting ? (
          ...
          >
            <div className="ios-glass p-8">
              ...
              <div className="space-y-6">
                <a href="mailto:jvallejoarguez@gmail.com" className="flex items-center gap-4 group">
                  <div className="p-3 rounded-xl bg-white/5 group-hover:bg-primary-500/20 transition-colors text-primary-400">
                    <Mail size={24} />
                  </div>
                  <div>
                    <div className="text-sm text-gray-400">Email</div>
                    <div className="text-white font-medium">jvallejoarguez@gmail.com</div>
                  </div>
                </a>
            ...
            <div className="ios-glass p-8">
              ...
              <div className="grid grid-cols-1 gap-4">
                <a href="https://github.com/jvallejoarguez" target="_blank" rel="noopener" className="flex items-center justify-between p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all group">
                  ...
                  <ArrowRight size={16} className="text-gray-500 group-hover:text-white transform group-hover:translate-x-1 transition-transform" />
                </a>
                <a href="https://linkedin.com/in/javier-vallejo-arguez" target="_blank" rel="noopener" className="flex items-center justify-between p-4 rounded-xl bg-white/5 hover:bg-white/10 transition-all group">
                  <div className="flex items-center gap-3">
